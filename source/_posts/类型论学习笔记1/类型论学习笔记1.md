...
{% mathjax %}
\begin{aligned}
t ::= {} & \text{true}         && \quad\text{// constant true} \newline
    \mid {} & \text{false}     && \quad\text{// constant false} \newline
    \mid {} & \text{if } t \text{ then } t \text{ else } t && \quad\text{// conditional} \newline
    \mid {} & 0                && \quad\text{// constant zero} \newline
    \mid {} & \text{succ } t   && \quad\text{// successor} \newline
    \mid {} & \text{pred } t   && \quad\text{// predecessor} \newline
    \mid {} & \text{iszero } t && \quad\text{// zero test}
\end{aligned}
{% endmathjax %}
